...
return axios.get('https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByPin',{params:{pincode: pin,date: givendate}}).then(function(response){console.log(response).catch(function (error) {
